...
#   c) node1 mines 32 blocks, so now node 0 has 500000GTR, node 1 has 4250GTR, node2 has none.
#   d) node0 sends 601 GTR to node2, in two transactions (301 GTR, then 300 GTR).
