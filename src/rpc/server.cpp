...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop GoldenTrillionCash server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "GoldenTrillionCash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GoldenTrillionCash features */
        {"GoldenTrillionCash", "masternode", &masternode, true, true, false},
        {"GoldenTrillionCash", "listmasternodes", &listmasternodes, true, true, false},
        {"GoldenTrillionCash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"GoldenTrillionCash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"GoldenTrillionCash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"GoldenTrillionCash", "masternodedebug", &masternodedebug, true, true, false},
        {"GoldenTrillionCash", "startmasternode", &startmasternode, true, true, false},
        {"GoldenTrillionCash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"GoldenTrillionCash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"GoldenTrillionCash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"GoldenTrillionCash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"GoldenTrillionCash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"GoldenTrillionCash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"GoldenTrillionCash", "mnbudget", &mnbudget, true, true, false},
        {"GoldenTrillionCash", "preparebudget", &preparebudget, true, true, false},
        {"GoldenTrillionCash", "submitbudget", &submitbudget, true, true, false},
        {"GoldenTrillionCash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"GoldenTrillionCash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"GoldenTrillionCash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"GoldenTrillionCash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"GoldenTrillionCash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"GoldenTrillionCash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"GoldenTrillionCash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"GoldenTrillionCash", "checkbudgets", &checkbudgets, true, true, false},
        {"GoldenTrillionCash", "mnsync", &mnsync, true, true, false},
        {"GoldenTrillionCash", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> GoldenTrillionCash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22988/\n";
}
