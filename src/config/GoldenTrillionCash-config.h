/* src/config/GoldenTrillionCash-config.h.  Generated from GoldenTrillionCash-config.h.in by configure.  */
/* src/config/GoldenTrillionCash-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "goldentrillion.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "GoldenTrillionCash"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "GoldenTrillionCash 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "GoldenTrillionCash"
