...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GoldenTrillionCash Core GoldenTrillionCash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  GoldenTrillionCash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded GoldenTrillionCash transaction") + "\n" +
                               "  GoldenTrillionCash-tx [options] -create [commands]   " + _("Create hex-encoded GoldenTrillionCash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded GoldenTrillionCash transaction
