...
public:
    ...
    void retranslateUi(QWidget *ReceiveCoinsDialog)
    {
...
#ifndef QT_NO_TOOLTIP
        label_3->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the GoldenTrillionCash network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        reqMessage->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened.<br>Note: The message will not be sent with the payment over the GoldenTrillionCash network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_5->setText(QApplication::translate("ReceiveCoinsDialog", "Use this form to request payments. All fields are optional", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("ReceiveCoinsDialog", "<html><head/><body><p>Amount: </p></body></html>", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ...
        label_6->setText(QApplication::translate("ReceiveCoinsDialog", "<html><head/><body><p><span style=\" color:#729fcf;\">Requested payments history</span></p></body></html>", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
