...
public:
    ...
    void setupUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        signatuGTRabel_SM = new QLabel(tabSignMessage);
        signatuGTRabel_SM->setObjectName(QStringLiteral("signatuGTRabel_SM"));
        signatuGTRabel_SM->setTextFormat(Qt::PlainText);

        verticalLayout_SM->addWidget(signatuGTRabel_SM);
    ...
    void retranslateUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        addressIn_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The GTR address to sign the message with", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        signatuGTRabel_SM->setText(QApplication::translate("SignVerifyMessageDialog", "Signature", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        signMessageButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this GTR address", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        addressIn_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The GTR address the message was signed with", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        verifyMessageButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified GTR address", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
