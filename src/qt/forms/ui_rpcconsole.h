...
public:
    ...
    QLabel *wallet_customzkydbackuppath_label;
    QLabel *wallet_customzkydbackuppath;
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        wallet_customzkydbackuppath_label = new QLabel(tab_repair);
        wallet_customzkydbackuppath_label->setObjectName(QStringLiteral("wallet_customzkydbackuppath_label"));
        wallet_customzkydbackuppath_label->setVisible(false);

        gridLayout_4->addWidget(wallet_customzkydbackuppath_label, 4, 0, 1, 1);

        wallet_customzkydbackuppath = new QLabel(tab_repair);
        wallet_customzkydbackuppath->setObjectName(QStringLiteral("wallet_customzkydbackuppath"));
        wallet_customzkydbackuppath->setCursor(QCursor(Qt::IBeamCursor));
        wallet_customzkydbackuppath->setVisible(false);
        wallet_customzkydbackuppath->setTextFormat(Qt::PlainText);
        wallet_customzkydbackuppath->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        gridLayout_4->addWidget(wallet_customzkydbackuppath, 4, 1, 1, 3);
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the GoldenTrillionCash debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        banHeading->setText(QApplication::translate("RPCConsole", "<html><head/><body><p><span style=\" color:#729fcf;\">Banned peers</span></p></body></html>", Q_NULLPTR));
        peerHeading->setText(QApplication::translate("RPCConsole", "<html><head/><body><p><span style=\" color:#729fcf;\">Select a peer to view detailed information.</span></p></body></html>", Q_NULLPTR));
        ...
        wallet_customzkydbackuppath_label->setText(QApplication::translate("RPCConsole", "Custom zKYD Backup Path:", Q_NULLPTR));
        wallet_customzkydbackuppath->setText(QApplication::translate("RPCConsole", "N/A", Q_NULLPTR));
