...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 GTR"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 GTR"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 GTR"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 GTR"));
        ...
        checkSwiftX = new QCheckBox(frame_Send);
        checkSwiftX->setObjectName(QStringLiteral("checkSwiftX"));
        checkSwiftX->setEnabled(true);
        checkSwiftX->setMinimumSize(QSize(85, 0));

        horizontalLayout_2->addWidget(checkSwiftX);
        ...
        labelBalance->setText(QStringLiteral("123.456 GTR"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlFeatures->setText(QApplication::translate("SendCoinsDialog", "<html><head/><body><p><span style=\" color:#66ccff;\">Coin Control Features</span></p></body></html>", Q_NULLPTR));
        ...
        labelBlockSize->setText(QApplication::translate("SendCoinsDialog", "0 GTR", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        radioCustomPerKilobyte->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uGTRs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uGTRs in fee,<br />while \"at least\" pays 1000 uGTRs. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomPerKilobyte->setText(QApplication::translate("SendCoinsDialog", "per kilobyte", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        radioCustomAtLeast->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uGTRs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uGTRs in fee,<br />while \"total at least\" pays 1000 uGTRs. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomAtLeast->setText(QApplication::translate("SendCoinsDialog", "total at least", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for GoldenTrillionCash transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for GoldenTrillionCash transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        checkSwiftX->setText(QApplication::translate("SendCoinsDialog", "SwiftX", Q_NULLPTR));
