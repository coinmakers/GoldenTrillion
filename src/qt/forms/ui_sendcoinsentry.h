...
public:
    ...
    void retranslateUi(QStackedWidget *SendCoinsEntry)
    {
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The GTR address to send the payment to", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        ...
        messageLabel->setText(QApplication::translate("SendCoinsEntry", "<html><head/><body><p><span style=\" color:#729fcf;\">Message:</span></p></body></html>", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the GoldenTrillionCash: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the GoldenTrillionCash network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
