...
public:
    ...
    void setupUi(QDialog *HelpMessageDialog)
    {
        ...
        HelpMessageDialog->setWindowTitle(QStringLiteral("GoldenTrillionCash - Command-line options"));
        HelpMessageDialog->setStyleSheet(QStringLiteral("background-color: rgb(19, 25, 44)"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 476, 213));
        QPalette palette;
        QBrush brush(QColor(19, 25, 44, 255));
