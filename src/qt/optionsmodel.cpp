...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::GTR);
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in GoldenTrillionCash.cpp during shotdown to also remove the window positions
