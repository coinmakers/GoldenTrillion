...
/** Utility functions used by the GoldenTrillionCash Qt UI.
 */
namespace GUIUtil
{
...
// Render GTR addresses in monospace font
...
// Parse "GoldenTrillionCash:" URI into recipient object, return true on successful parsing
