                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GoldenTrillionCash") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GTR address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and GoldenTrillionCash: URIs)"));
  ...
  //  tabGroup->addAction(proposalAction);
   ...
   // connect(proposalAction, SIGNAL(triggered()), this, SLOT(gotoProposalPage()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GoldenTrillionCash"), this);
    aboutAction->setStatusTip(tr("Show information about GoldenTrillionCash"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GoldenTrillionCash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GTR addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GTR addresses"));
    ...
    openAction->setStatusTip(tr("Open a GoldenTrillionCash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GoldenTrillionCash help message to get a list with possible GoldenTrillionCash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GoldenTrillionCash client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GoldenTrillionCash network", "", count));
}
...
{
    QString strTitle = tr("GoldenTrillionCash"); // default title
    ...
    // Append title to "GoldenTrillionCash - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
