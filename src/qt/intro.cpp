...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("GoldenTrillionCash Core"),
     ...
     * override -datadir in the GoldenTrillionCash.conf file in the default data directory
     * (to be consistent with GoldenTrillionCashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
