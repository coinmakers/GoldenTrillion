Contributing to GoldenTrillionCash Core
==================================

The GoldenTrillionCash Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to GoldenTrillionCash-qt
  - *Minting* for changes to the minting code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST* for changes to the RPC or REST APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the GoldenTrillionCash unit tests or QA tests
...
The following applies to code changes to the GoldenTrillionCash Core project, and is not to be
confused with overall GoldenTrillionCash Network Protocol consensus changes.

Whether a pull request is merged into GoldenTrillionCash Core rests with the project merge
...
Patches that change GoldenTrillionCash consensus rules are considerably more involved than
...
Where a patch set proposes to change the GoldenTrillionCash consensus, it must have been
...
The project leader is the release manager for each GoldenTrillionCash Core release.
