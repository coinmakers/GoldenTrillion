...
This mechanism has been integrated into Bitcore-Node-GoldenTrillionCash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/GoldenTrillionCash/insight-api-GoldenTrillionCash#web-socket-api](https://github.com/GoldenTrillionCash/insight-api-GoldenTrillionCash#web-socket-api)
* API: [https://github.com/GoldenTrillionCash/insight-api-GoldenTrillionCash#swifttx-transactions](https://github.com/GoldenTrillionCash/insight-api-GoldenTrillionCash#swifttx-transactions)
...
By default, the GoldenTrillionCash Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GoldenTrillionCash Core daemon:
